...
### 🚨 최우선: 성의 있는 답변인가? (필수 조건)
- 의미 없는 글자 나열 (예: "ㅁㄴㄹㅇ", "asdf", "ㅋㅋㅋ", "..." 등) → **무조건 최하위**
- 너무 짧은 답변 (3단어 미만, 10글자 미만) → **큰 감점**
- 질문과 무관한 답변 → **최하위**
- 성의 없는 답변은 아무리 좋은 선택을 해도 낮은 점수를 받아야 합니다!

### 일반 평가 기준 (성의 있는 답변에만 적용)
1. 논리성: 선택 이유가 논리적이고 설득력 있는가? (가장 중요)
2. 상황 이해도: 문제 상황을 정확히 파악했는가?
3. 리더십 관점: 리더로서 적절한 판단인가?
4. 구체성: 답변이 구체적이고 명확한가?
