...
// 기본 리포트 생성 지침
export const DEFAULT_REPORT_GENERATION_GUIDELINES = `## 리포트 생성 지침

### 팀별 리포트 작성 기준
1. 각 팀의 전체 라운드 응답 패턴 분석
2. 강점과 개선점을 균형있게 제시
3. 구체적인 사례를 들어 피드백 제공
4. 건설적이고 동기부여가 되는 톤 유지

### 종합 리포트 작성 기준
1. 전체 팀들의 응답 경향성 분석
2. 우수 사례와 개선 필요 사례 비교
3. 학습 포인트와 실무 적용 방안 제시
4. 향후 발전 방향에 대한 제언 포함
5. 각 팀이 함께 토의할 토론주제 3가지`;
